...
def main():
    ...
    if dataType == "evolution-chain":
        with open(r"../Raw_Data/Raw_Pokemon_Data.json", "r") as f:
            rawPokemonData = json.load(f)
        with open(r"../Raw_Data/Raw_Pokemon-species_Data.json", "r") as f:
    ...
    Write(outputDictionary, fr"../Raw_Data/Raw_{dataType.capitalize()}_Data.json")
